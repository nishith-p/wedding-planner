...
<head>
	<title>Wedding Planner | Wedding Cars</title>
...
<body> 
	...
	<img class="dress-img-1" src="images/product-car/main.png"></img>
	<div class="sub-nav">
	...
	<?php
		...
		$sql = "SELECT * FROM product WHERE product_type='weddingcar';";
    ...
    <a class="button" href="view-car.php?id=<?php echo $row['product_id'];?>">View</a>
	</figure>
