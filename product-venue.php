...
<head>
	<title>Wedding Planner | Venue</title>
...
<body> 
	...
	<img class="dress-img-1" src="images/product-venue/main.png"></img>
	<div class="sub-nav">
	...
	<?php
		...
		$sql = "SELECT * FROM product WHERE product_type='venue';";
    ...
    <a class="button" href="view-venue.php?id=<?php echo $row['product_id'];?>">View</a>
	</figure>
